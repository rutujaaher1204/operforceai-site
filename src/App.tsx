...
//               path="/"
//               element={
//                 //  <div className="bg-brand-gradient text-white bg-[length:200%_200%] animate-gradient-x min-h-screen flex flex-col justify-between"> 
...
//                     <Products />
//                   </div>
//                   <Footer theme="dark" /> {/* White text for dark bg */}
//                 </div>
//               }
//             />
...
//                   <CareersPage />
//                   <Footer theme="light" /> {/* Dark text for light bg */}
//                 </div>
//               }
//             />
