...
//           <h1 className="font-heading text-heading40 md:text-heading40  text-[#5b2333] leading-tight">
//             Agentic AI Business Software for SMBs
//           </h1>

//           <p className="text-body18 font-body text-slate-700/90">
...
//             className="block mt-6 text-body18 text-indigo-600  hover:underline"
//           >
