...
//       {/* Description */}
//       <p className="text-[16px] font-semibold font-heading text-gray-800 leading-relaxed mb-8">{description}</p>

//       {/* Responsibilities */}
//       {responsibilities.length > 0 && (
//         <div className="mb-8">
//           <h5 className="text-[20px] font-semibold font-heading text-gray-900 mb-3">Responsibilities</h5>
//           <ul className="list-disc list-inside font-body text-body16 space-y-2 text-gray-800">
...
//         <div className="mb-8">
//           <h5 className="text-[20px] font-semibold font-heading text-gray-900 mb-3">Qualifications</h5>
//           <ul className="list-disc list-inside font-body text-body16 space-y-2 text-gray-800">
...
//       {attributes.length > 0 && (
//         <div className="mb-10">
//           <h5 className="text-[20px] font-semibold font-heading text-heading32  text-gray-900 mb-3">Personal Attributes</h5>
//           <ul className="list-disc list-inside font-body text-body16 space-y-2 text-gray-800">
